...
load_dotenv()  # загружает .env из корня проекта или рабочей директории

from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware

from api.routes import buildings, infrastructure, analyze, optimize, isochrone, coverage, regions, infrastructure_edit
...
app.include_router(infrastructure_edit.router, tags=["Данные"])
